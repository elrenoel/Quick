...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.error) {
        setErrorMessage(
          res.error.message || "Email atau password salah. Silakan periksa kembali."
        );
        setIsLoading(false);
        return;
      }

      // Login berhasil, periksa apakah ada data trial yang perlu dimigrasi
    ...
    <div className="bg-white border border-neutral-200 rounded-2xl p-8 shadow-xs">
      <div className="mb-6 text-center">
        ...
        <p className="text-xs text-neutral-500">
          Masuk untuk mengelola materi flashcard & kuis Anda.
        </p>
      </div>
        ...
        <Suspense
          fallback={
            <div className="bg-white border border-neutral-200 rounded-2xl p-8 shadow-xs text-center">
              ...
              <p className="text-xs text-neutral-500">Memuat formulir masuk...</p>
            </div>
          }
        >
          <LoginForm />
